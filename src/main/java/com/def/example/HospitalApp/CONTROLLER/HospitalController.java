package com.def.example.HospitalApp.CONTROLLER;
...
import com.def.example.HospitalApp.SERVICE.HospitalService;
...
public class HospitalController {
    ...
    public HospitalDTO getParticularHospital(@PathVariable Integer hospitalId)
    {
